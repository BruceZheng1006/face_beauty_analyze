    ...
    try:
        ...
        if result.face_landmarks:
            for face_idx, landmarks in enumerate(result.face_landmarks):
                ...
                if eye_width < eye_width_thresholds[0]:
                    eye_width_grade = "眼宽超小"
                elif eye_width_thresholds[0] <= eye_width < eye_width_thresholds[1]:
                    eye_width_grade = "眼宽小"
                elif eye_width_thresholds[1] <= eye_width < eye_width_thresholds[2]:
                    eye_width_grade = "眼宽稍小"
                elif eye_width_thresholds[2] <= eye_width < eye_width_thresholds[3]:
                    eye_width_grade = "眼宽标准"
                elif eye_width_thresholds[3] <= eye_width < eye_width_thresholds[4]:
                    eye_width_grade = "眼宽稍大"
                elif eye_width_thresholds[4] <= eye_width < eye_width_thresholds[5]:
                    eye_width_grade = "眼宽大"
                else:
